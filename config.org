...
(use-package diff-hl
  ...
  ;; Function to refresh diff-hl for the current buffer
  (defun my/diff-hl-refresh-buffer ()
    "Refresh diff-hl for the current buffer if it's visiting a file."
    (when (buffer-file-name)
      (diff-hl-update)))

  ;; Refresh after saving a file
  (add-hook 'after-save-hook #'my/diff-hl-refresh-buffer)

;; ------------------------------
;; Force refresh diff-hl hunks
;; ------------------------------
...
;; Bind it somewhere convenient, e.g., under your C-c g prefix
