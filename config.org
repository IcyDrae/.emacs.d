...
- [[#custom-keybindings][Custom keybindings]]
  ...
  - [[#auto-highlight-references-under-cursor][Auto highlight references under cursor]]
- [[#vterm][vterm]]
...
(defun reard/duplicate-line ()
  "Duplicate current line and move point to the duplicate, keeping column."
  (interactive)
...
(global-set-key (kbd "C-c d") #'reard/duplicate-line)

;; Comment line or selected region
...
(use-package indent-bars
  ...
  ;; Optional: make them slightly thinner
  (setq indent-bars-width-frac 0.1)

  ;; Optional: only show in indentation (cleaner look)
