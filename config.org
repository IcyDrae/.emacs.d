...
(use-package diff-hl
  ...
  ;; Automatically remove fringe indicators for files that are clean in Git
  (defun my/diff-hl-clear-if-committed ()
    "Clear diff-hl indicators for the current file if it's clean in Git."
  ...
  ;; Run after saving a file
  (add-hook 'after-save-hook #'my/diff-hl-clear-if-committed))

;; ------------------------------
;; Shortcut to show hunk manually
;; ------------------------------
